...
<fieldset class="bbp-form signature-wrapper">
    ...
    <div>
        <!--<label for="signature"><?php //_e("Signature", "gd-bbpress-tools"); ?></label><br /><br />-->
        <fieldset class="bbp-form signature">
            ...
            <?php
			$forum_signature = bbp_get_displayed_user_field('signature');
			wp_editor($forum_signature, 'signature', array('teeny' => false, 'media_buttons' => false, 'textarea_rows' => 5,'textarea_name'=>'signature'));
			?>
