...
<?php
	...
	function wdt_admin_styles() {
        ...
        wp_register_style('wpdatatables-min',PDT_CSS_PATH.'wpdatatables.min.css');
        wp_enqueue_style('wpdatatables-min');
        wp_register_style('pickadate-default',PDT_ASSETS_PATH.'css/datepicker.default.css');
        wp_enqueue_style('pickadate-default');
        wp_register_style('pickadate-default-date',PDT_ASSETS_PATH.'css/datepicker.default.date.css');
        ...
        wp_register_style('tabletools',PDT_CSS_PATH.'TableTools.css');
        wp_enqueue_style('tabletools');
        wp_register_style('datatables-responsive',PDT_ASSETS_PATH.'css/datatables.responsive.css');
        ...
        wp_register_style('wpdatatables-admin',PDT_ASSETS_PATH.'css/wpdatatables_admin.css');
	...
	function wpdatatables_browse() {
		...
		if($action == 'edit'){
			...
			// Admin JS
			$tpl->addJs(PDT_JS_PATH.'wpdatatables/wpdatatables_admin.js');
			// Selecter
			$tpl->addJs(PDT_JS_PATH.'selecter/jquery.fs.selecter.min.js');
			$tpl->addCss(PDT_CSS_PATH.'jquery.fs.selecter.css');
			// Picker
			$tpl->addJs(PDT_JS_PATH.'picker/jquery.fs.picker.min.js');
			$tpl->addCss(PDT_CSS_PATH.'jquery.fs.picker.css');
			// Popup
			$tpl->addJs(PDT_JS_PATH.'popup/jquery.remodal.min.js');
			$tpl->addCss(PDT_CSS_PATH.'jquery.remodal.css');
