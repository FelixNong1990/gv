				...
				wpDataTablesFunctions[tableDescription.tableId].saveTableData = function(forceRedraw){
						...
						$(tableDescription.selector+'_edit_dialog .editDialogInput').each(function(){
							...
							if($(this).hasClass('datepicker')){
								formdata[$(this).data('key')] = $.datepicker.formatDate(tableDescription.datepickFormat, $.datepicker.parseDate($.datepicker.regional[""].dateFormat,$(this).val()));
			...
			if(tableDescription.editable){
					 ...
					 */
					  ...
					  */
				 	  ...
				 	  * Apply pickadate
				 	  */
				 	  var dateFormat = tableDescription.datepickFormat.replace(/y/g,'yy');
				 	  $(tableDescription.selector+'_edit_dialog input.datepicker').pickadate({format: dateFormat, formatSubmit: dateFormat, editable: true});
