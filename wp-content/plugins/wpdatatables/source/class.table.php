...
class PHPDataTable {
	 ...
	 */
       ...
       */
       ...
       /**
        * Flag which defines if filtering will be in the box
        */
    ...
    public function getColumnDefs() {
            ...
            foreach($this->_columns as $key=>$column){
                    ...
                    $defs[] = json_encode($def);
                    $href = site_url() . '/edit-video/?pid=' . $rand . '&_wpnonce=' . $nonce;
                    $content = '<a href=\"' .  '#' . '\" class=\"btn btn-info btn-sm editLink\"><i class=\"fa fa-edit\"></i> Edit</a>' .
								'<a href=\"' .  '#' . '\" class=\"btn btn-danger btn-sm deleteLink confirm\"><i class=\"fa fa-trash-o\"></i> Delete</a>';
                    $defs[] = '{"aTargets":[4],"mData": null,"bSortable": false, "sDefaultContent":"' . $content . '"}';
            }
...
//                    }
			...
			//$defs[] = '{"mData": null,"bSortable": false,"mRender": function (o) { return "<p>Test</p>";}}';
            //$defs[] = '{"defaultContent": "<button>Click!</button>"}';
            return implode(', ', $defs); 	
     }
