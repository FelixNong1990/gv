	...
	?>
			<div class="userpro-admin-head">
				<div class="userpro-admin-left">
					...
					<span class="userpro-admin-span"><?php if (get_option('userpro_activated')) { _e('Thank you for activating UserPro!','userpro'); } else { _e('Thankyou for Purchasing Userpro by HaselBiscuit in BBHF','userpro'); } ?></span>
				</div>
				<div class="userpro-admin-right">
					...
					<a href="http://bestblackhatforum.com/Thread-GET-Always-Updated-UserPro-User-Profiles-with-Social-Login-v-1-0-90" class="button button-primary"><?php _e('Download Latest in BBHF','userpro'); ?></a>
				</div>
				<div class="clear"></div>
			</div>
	<?php
