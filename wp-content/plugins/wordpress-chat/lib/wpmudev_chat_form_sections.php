...
<?php */ ?>
			...
			<tr>
				<td class="chat-label-column"><label for="chat_log_display_label"><?php _e("Log Display Label", $wpmudev_chat->translation_domain); ?></label></td>
				<td class="chat-value-column">
			...
			<tr>
				<td class="chat-label-column"><label for="chat_log_display_limit"><?php _e("Number of Archive Entries to Show in Listing", $wpmudev_chat->translation_domain); ?></label></td>
				<td class="chat-value-column">
			...
			<tr>
				<td class="chat-label-column"><label for="chat_log_display_hide_session"><?php _e("When Viewing Archive Details. Show/Hide Main Chat?", $wpmudev_chat->translation_domain); ?></label></td>
				<td class="chat-value-column">
			...
			<?php
				...
				if ($form_section == "bp-group") {
					...
					if (count($log_display_levels)) {
						?>
						<tr>
							<td class="chat-label-column"><label for="chat_log_display_role_level"><?php _e("Limit Display by Group Member Level",
					...
					if (count($log_display_levels)) {
						?>
						<tr>
							<td class="chat-label-column"><label for="chat_log_display_role_level"><?php _e("Limit Display by User Role Level",
								$wpmudev_chat->translation_domain); ?></label></td>
							<td class="chat-value-column">
								<select id="chat_log_display_role_level" name="chat[log_display_role_level]">
	...
	<fieldset>
		...
		<tr>
			<td class="chat-label-column-wide">
				<p class="info"><strong><?php _e("Show for WordPress User. Automatically includes Admin and SuperAdmin users. User must already be authenticated.", $wpmudev_chat->translation_domain); ?></strong></p>
				...
				<?php if ((is_multisite()) && ($form_section != "network-site")) { ?>
					<p class="info"><strong><?php _e("Show for Network Users. If unchecked then only WordPress users with access to the current blog will be able to see the chat session.", $wpmudev_chat->translation_domain); ?></strong></p>
				...
				<?php if ($form_section != 'dashboard') { ?>
					<p class="info"><strong><?php _e("Other Login Options:", $wpmudev_chat->translation_domain); ?></strong></p>
					<ul id="wpmudev-chat-login-options-list-other" class="wpmudev-chat-user-roles-list">
						...
						<li><input type="checkbox" id="chat_login_options_public_user"
							...
							<?php print (in_array('public_user', $wpmudev_chat->get_option('login_options', $form_section)) > 0)?'checked="checked"':''; ?>
							 /> <label><?php _e('Public users', $wpmudev_chat->translation_domain); ?></label></li>
...
<?php */ ?>
		...
		<tr>
			<td class="chat-label-column"><label for="chat_box_popup"><?php _e("Allow Chat Pop out/in", $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
		...
		<tr>
			<td class="chat-label-column"><label for="chat_box_moderator_footer"><?php _e("Show Moderator Message Footer", $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
...
function wpmudev_chat_form_section_messages_rows($form_section = 'page') {
	...
	<fieldset>
		...
		<tr id="chat_row_name_color_tr" <?php if (($row_name_avatar != "name") && ($row_name_avatar != "name-avatar")) { echo ' style="display:none" '; } ?> >
		...
		<tr id="chat_row_moderator_name_color_tr" <?php if (($row_name_avatar != "name") && ($row_name_avatar != "name-avatar")) { echo ' style="display:none" '; } ?>>
...
function wpmudev_chat_form_section_messages_input($form_section = 'page') {
	...
	<fieldset>
		...
		<tr>
			<td class="chat-label-column"><label for="chat_row_message_input_lock"><?php _e('Prevent user from changing height', $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
...
function wpmudev_chat_form_section_messages_send_button($form_section = 'page') {
	...
	<fieldset>
		...
		<table border="0" cellpadding="4" cellspacing="0">
		<tr>
			<td class="chat-label-column"><label for="chat_send_button_enable"><?php _e("Send Button Enabled", $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
		...
		<tr>
			<td class="chat-label-column"><label for="chat_box_send_button_position"><?php _e("Send Button Position", $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
		...
		<tr>
			<td class="chat-label-column"><label for="chat_box_send_button_label"><?php _e("Send Button Label", $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
...
function wpmudev_chat_form_section_moderator_roles($form_section = 'page') {
	...
	<fieldset>
		...
		<tr>
			<td class="chat-label-column-wide">
				<p class="info"><strong><?php _e("Automatically includes Admin and SuperAdmin users", $wpmudev_chat->translation_domain); ?></strong></p>
						...
						if (count($wp_roles)) {
							foreach ($wp_roles->roles as $role_slug => $role) {
								...
								?><li><input type="checkbox" id="chat_moderator_roles_<?php print $role_slug; ?>"
									...
									<?php echo $checked; ?> <?php echo $disabled; ?> /> <label><?php echo $role['name']; ?></label></li><?php
...
function wpmudev_chat_form_section_polling_interval($form_section = 'global') {
	...
	<fieldset>
		...
		<p class="info"><strong><?php _e('Suggestion: The New Message polling is the main loop. The polling values for Invites and Meta should be multiples of the New Messages value. For example if New Message polling is 2 seconds. Consider Invites value of 4 seconds and Meta value of 6 seconds.', $wpmudev_chat->translation_domain); ?></strong></p>

		<table border="0" cellpadding="4" cellspacing="0">
		<tr>
			<td class="chat-label-column chat-label-column-top"><label for="chat_session_poll_interval_messages"><?php _e('How often to poll for new messages',
				$wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
		...
		<tr>
			<td class="chat-label-column chat-label-column-top"><label for="chat_session_poll_interval_invites"><?php _e('How often to poll for invites',
				$wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
		...
		<tr>
			<td class="chat-label-column chat-label-column-top"><label for="chat_session_poll_interval_meta"><?php _e('How often to update meta data',
				$wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
...
function wpmudev_chat_form_section_polling_content($form_section = 'global') {
	...
	<fieldset>
		...
		<table border="0" cellpadding="4" cellspacing="0">
		<tr>
			<td class="chat-label-column chat-label-column-top"><label for="chat_session_poll_type"><?php _e('Select Polling Source Type',
				$wpmudev_chat->translation_domain); ?></label></td>
...
function wpmudev_chat_form_section_performance_content($form_section = 'global') {
	...
	<fieldset>
		...
		<table border="0" cellpadding="4" cellspacing="0">
		<tr>
			<td class="chat-label-column chat-label-column-top"><label for="chat_session_performance"><?php _e('Enable Performace/Debug output',
				$wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
...
function wpmudev_chat_form_section_blocked_ip_addresses_global($form_section = 'global') {
	...
	<fieldset>
		...
		<table border="0" cellpadding="4" cellspacing="0">
		<tr>
			<td class="chat-label-column"><label for="chat_blocked_ip_addresses_active"><?php _e('Active for ALL Chat Sessions?', $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
...
function wpmudev_chat_form_section_bottom_corner($form_section = 'site') {
	...
	<fieldset>
		...
		if (($wpmudev_chat->_chat_plugin_settings['network_active'] == true) && (!is_network_admin())) {
			if ($wpmudev_chat->get_option('bottom_corner', 'network-site') == 'enabled') {
				?>
				<div class="error"><p class="info"><?php _e('The Bottom Corner Chat has been Network enabled by the Super Admin. This means it will preclude your local site Bottom Corner Chat visibility.', $wpmudev_chat->translation_domain); ?></p></div>
				<?php
			}
			if ($wpmudev_chat->get_option('bottom_corner_wpadmin', 'network-site') == 'enabled') {
				?>
				<div class="error"><p class="info"><?php _e('The Bottom Corner WPAdmin Chat has been Network enabled by the Super Admin. This means it will preclude your local site Bottom Corner WPAdmin Chat visibility.', $wpmudev_chat->translation_domain); ?></p></div>
				<?php
			}
		}
		?>
		...
		<tr>
			<td class="chat-label-column"><label for="chat_site_status_max_min"><?php _e('Display Bottom Corner Initial View',
			 	$wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
		...
		<tr>
			<td class="chat-label-column"><label for="chat_site_poll_max_min"><?php _e('When Minimized poll for New Messages?',
			 	$wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
	...
	<fieldset>
		...
		<table border="0" cellpadding="4" cellspacing="0">
		<tr>
			<td class="chat-label-column"><label for="chat_private_reopen_after_exit"><?php _e('Allow Private Chat popup to reopen after existing?',
			 	$wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
...
function wpmudev_chat_users_list($form_section = 'page') {
	...
	<fieldset>
		...
		<table border="0" cellpadding="4" cellspacing="0">
		<tr>
			<td class="chat-label-column"><label for="chat_users_list_position"><?php _e("Show Users List Position", $wpmudev_chat->translation_domain);
			 	?></label></td>
			<td class="chat-value-column">
		...
		<tr>
			<td class="chat-label-column"><label for="chat_users_list_style"><?php _e("Show Moderators and Users", $wpmudev_chat->translation_domain);
			 	?></label></td>
			<td class="chat-value-column">
		...
		<tr id="chat_users_list_width_tr">
			<td class="chat-label-column"><label for="chat_users_list_threshold_delete"><?php _e('Remove Inactive User after (seconds)',
			 $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
		...
		<tr>
			<td class="chat-label-column"><label for="chat_users_list_header"><?php _e("Header Above Lists", $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
		...
		<tr>
			<td class="chat-label-column"><label for="chat_users_list_header_font_family"><?php _e("Header Font", $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
		...
		<tr>
			<td class="chat-label-column"><label for="chat_users_list_header_font_size"><?php _e("Header Font Size", $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
				<?php
		...
		<tr>
			<td class="chat-label-column"><label for="chat_users_list_header_color"><?php _e('Header Text Color', $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
		...
		<tr id="chat_users_list_avatar_border_width_tr" <?php if ($users_list_show != "avatar") { echo ' style="display:none" '; } ?>>
			<td class="chat-label-column"><label for="chat_users_list_avatar_border_width"><?php _e('User Avatar Border Width', $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
		...
		<tr id="chat_users_list_moderator_avatar_border_color_tr"  <?php if ($users_list_show != "avatar") { echo ' style="display:none" '; } ?>>
		...
		<tr id="chat_users_list_user_avatar_border_color_tr"  <?php if ($users_list_show != "avatar") { echo ' style="display:none" '; } ?>>
		...
		<tr id="chat_users_list_moderator_color_tr"  <?php if ($users_list_show != "name") { echo ' style="display:none" '; } ?>>
			<td class="chat-label-column"><label for="chat_users_list_moderator_color"><?php _e('Moderator Name Color', $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
...
function wpmudev_chat_form_section_wpadmin($form_section = 'global') {
	...
	<fieldset>
		...
		<tr>
			<td class="chat-label-column chat-label-column-top"><label for="wpmudev_chat_wp_admin"><?php _e('Show Chats within WPAdmin', $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
		...
		<tr>
			<td class="chat-label-column chat-label-column-top"><label for="wpmudev_chat_users_listing"><?php _e('Show Chat Status Column on Users > All Users listing?', $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
		...
		<tr>
			<td class="chat-label-column"><label for="wpmudev_chat_dashboard"><?php _e('Show Chat Widget on Dashboard', $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
	            <select name="chat_user_meta[chat_dashboard]" id="wpmudev_chat_dashboard">
	            	<option value="enabled"<?php if ( $wpmudev_chat->_chat_options_defaults['user_meta']['chat_dashboard'] == 'enabled' ) { echo ' selected="selected" '; } ?>><?php
						_e('Enabled', $wpmudev_chat->translation_domain); ?></option>
	            	<option value="disabled"<?php if ( $wpmudev_chat->_chat_options_defaults['user_meta']['chat_dashboard'] == 'disabled' ) { echo ' selected="selected" '; } ?>><?php
						_e('Disabled', $wpmudev_chat->translation_domain); ?></option>
	            </select>
			</td>
			<td class="chat-help-column"><?php //echo wpmudev_chat_get_help_item('bp_form_background_color', 'tip'); ?></td>
		...
		<tr>
			<td class="chat-label-column"><label for="wpmudev_chat_dashboard_status"><?php _e('Show Chat Status Widget on Dashboard', $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
	            <select name="chat_user_meta[chat_dashboard_status_widget]" id="wpmudev_chat_dashboard_status_widget">
	            	<option value="enabled"<?php if ( $wpmudev_chat->_chat_options_defaults['user_meta']['chat_dashboard_status_widget'] == 'enabled' ) { echo ' selected="selected" '; } ?>><?php
						_e('Enabled', $wpmudev_chat->translation_domain); ?></option>
	            	<option value="disabled"<?php if ( $wpmudev_chat->_chat_options_defaults['user_meta']['chat_dashboard_status_widget'] == 'disabled' ) { echo ' selected="selected" '; } ?>><?php
						_e('Disabled', $wpmudev_chat->translation_domain); ?></option>
	            </select>
			</td>
			<td class="chat-help-column"><?php //echo wpmudev_chat_get_help_item('bp_form_background_color', 'tip'); ?></td>
		...
		<tr>
			<td class="chat-label-column"><label for="wpmudev_chat_dashboard_friends"><?php _e('Show Chat Friends Widget on Dashboard', $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
	            <select name="chat_user_meta[chat_dashboard_friends_widget]" id="wpmudev_chat_dashboard_friends_widget">
	            	<option value="enabled"<?php if ( $wpmudev_chat->_chat_options_defaults['user_meta']['chat_dashboard_friends_widget'] == 'enabled' ) { echo ' selected="selected" '; } ?>><?php
						_e('Enabled', $wpmudev_chat->translation_domain); ?></option>
	            	<option value="disabled"<?php if ( $wpmudev_chat->_chat_options_defaults['user_meta']['chat_dashboard_friends_widget'] == 'disabled' ) { echo ' selected="selected" '; } ?>><?php
						_e('Disabled', $wpmudev_chat->translation_domain); ?></option>
	            </select>
			</td>
			<td class="chat-help-column"><?php //echo wpmudev_chat_get_help_item('bp_form_background_color', 'tip'); ?></td>
	...
	<fieldset>
		...
		<tr>
			<td class="chat-label-column chat-label-column-top"><label for="chat_delete_user_messages"><?php _e('Remove Chat messages when WordPress user is deleted',
				$wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
...
//	echo "wpmudev_chat<pre>"; print_r($wpmudev_chat->_chat_options); echo "</pre>";
	...
	<fieldset>
		...
		<tr>
			<td class="chat-label-column"><label for="dashboard_widget_title"><?php _e("Title", $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
	...
	<fieldset>
		...
		<tr>
			<td class="chat-label-column"><label for="dashboard_status_widget_title"><?php _e("Title", $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
	...
	<fieldset>
		...
		<tr>
			<td class="chat-label-column"><label for="dashboard_friends_widget_title"><?php _e("Title", $wpmudev_chat->translation_domain); ?></label></td>
			<td class="chat-value-column">
