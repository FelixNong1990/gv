    ...
    */
    ...
    function get_multiple_content() {
        ...
        ?>
            ...
            <div style="display:none; background:url(<?php echo $options['multipleToggleElement']; ?>) no-repeat; background-size:cover; width:30px; height:30px" id="<?php echo $prefix; ?>-multiple-toggle"></div>
        <?php
