	...
	<div class="clr"></div>
		...
		<div class="fusion-sharing-box share-box">
			...
			<div class="fusion-social-networks boxed-icons">
				<a class="fusion-social-network-icon fusion-tooltip fusion-facebook icon-facebook" style="color:#bebdbd;background-color:#e8e8e8;border-color:#e8e8e8;border-radius:4px;" href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent(location.href),'facebook-share-dialog','width=626,height=436');return false;" target="_blank" data-placement="top" data-title="Facebook" data-toggle="tooltip" data-original-title="" title=""></a>
				<a class="fusion-social-network-icon fusion-tooltip fusion-twitter icon-twitter" style="color:#bebdbd;background-color:#e8e8e8;border-color:#e8e8e8;border-radius:4px;" href="#" onclick="window.open('http://twitter.com/home?status=<?php echo urlencode($post->post_title); ?>:%0a<?php the_permalink(); ?> via @GameVeins','twitter-share-dialog','width=626,height=436');return false;" target="_blank" data-placement="top" data-title="Twitter" data-toggle="tooltip" data-original-title="" title=""></a>
				<?php 
					$id = get_the_ID();
					$url = get_post_meta($id, 'post_meta_embed_code', true);
					if (preg_match('%(?:youtube(?:-nocookie)?\.com/(?:[^/]+/.+/|(?:v|e(?:mbed)?)/|.*[?&]v=)|youtu\.be/)([^"&?/ ]{11})%i', $url, $match)) {
				...
				?>
				<a class="fusion-social-network-icon fusion-tooltip fusion-pinterest icon-pinterest" style="color:#bebdbd;background-color:#e8e8e8;border-color:#e8e8e8;border-radius:4px;" href="#" onclick="window.open('http://pinterest.com/pin/create/button/?url=<?php echo urlencode(get_permalink()); ?>&amp;description=<?php echo urlencode($post->post_title); ?>&amp;media=<?php echo $full_image; ?>','pinterest-share-dialog','width=626,height=436');return false;" target="_blank" data-placement="top" data-title="Pinterest" data-toggle="tooltip" data-original-title="" title=""></a>
				<a class="fusion-social-network-icon fusion-tooltip fusion-tumblr icon-tumblr" style="color:#bebdbd;background-color:#e8e8e8;border-color:#e8e8e8;border-radius:4px;" href="#" onclick="window.open('http://www.tumblr.com/share/link?url=<?php echo urlencode(get_permalink()); ?>&amp;name=<?php echo urlencode($post->post_title); ?>&amp;description=<?php echo urlencode(get_the_excerpt()); ?>','tumblr-share-dialog','width=626,height=436');return false;" target="_blank" data-placement="top" data-title="Tumblr" data-toggle="tooltip" data-original-title="" title=""></a>
